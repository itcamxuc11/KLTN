  ...
  _renderWithOutLogin() {
    return (
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item">
          <span className="nav-link text-uppercase mr-2"><Link to="/login">Đăng nhập / Đăng ký</Link></span>
        </li>
        <li className="nav-item">
          <Link to="/register-restaurant">
            <button type="button" className="btn btn-warning btn-sm text-uppercase mr-2 mr-1 px-3">Đăng ký cửa hàng</button>
          </Link>
        </li>
      </ul>
    )
  ...
  _renderWithLogin() {
    ...
    if (updated_user.isRestaurant) {
      return (
        <ul className="navbar-nav ml-auto">
          <li className="nav-item">
            <span className="nav-link active text-uppercase mr-2"><Link to="/add-menu-items">Thêm sản phẩm</Link></span>
          </li>
          <li className="nav-item">
            <span className="nav-link active text-uppercase mr-2"><Link to="/my-foods">Danh sách sản phẩm</Link></span>
          </li>
          <li className="nav-item">
            <span className="nav-link active text-uppercase mr-2"><Link to="/order-requests">Đơn hàng</Link></span>
          </li>
          <li className="nav-item">
      ...
      return (
        <ul className="navbar-nav ml-auto">
          <li className="nav-item">
            <span className="nav-link active text-uppercase mr-2"><Link to="/restaurants">Danh sách cửa hàng</Link></span>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <button type="button" className="btn btn-warning btn-sm text-uppercase mr-2 mr-1 px-3" onClick={() => this.handleLogOutBtn()}>Đăng xuất</button>
          </li>
        </ul>
      )
    }
