            ...
            <div className="container-fluid pt-5 bg-footer">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            <div className="footer-head-div">
                                <h5 className="text-white">Header 1</h5>
                            </div>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            <div className="footer-head-div">
                                <h5 className="text-white">Header 2</h5>
                            </div>
                            <div className="footer-list-div">
                                <ul>
                                    <li><a href="#">Gà rán</a></li>
                                    <li><a href="#">Thịt vịt</a></li>
                                    <li><a href="#">Thịt mèo</a></li>
                                    <li><a href="#">Bia huda</a></li>
                                    <li><a href="#">Rượu nếp</a></li>
                                    <li><a href="#">Muối tiêu</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    <li className="pb-3">
                                        ...
                                        <span>032 845214</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                            <FontAwesomeIcon icon="envelope" className="text-white" />
                                        </span>
                                        <span>cutgaquangri@gmail.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2020 Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Duy Chien</span></p>
                    </div>
                </div>
            </div>
        );
