...
export default class Login extends Component {
    constructor() {
        ...
        this.state = {
            ...
            registerFormError: "",
            userProfileImageLable: "Chọn avatar",
            userName: "",
            userEmail: "",
            userPassword: "",
    ...
    handleUserPassword(e) {
        ...
        if (userPassword.match(userPasswordFormate)) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Sử dụng số, chữ thường, chữ hoa và dài hơn 10 ký tự",
                userPassword: "",
            });
        }
    }
    ...
    handleUserConfirmPassword(e) {
        ...
        if (userConfirmPassword.match(userPassword)) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Nhập lại mật khẩu không khớp.",
                userConfirmPassword: false,
            });
        }
    }
    ...
    handleUserCountry(e) {
        ...
        if (userCountry.match(userCountryFormate)) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Không hợp lệ.",
                userCountry: "",
            });
        }
    }
    ...
    handleUserProfileImage(e) {
        if (e.target.files[0] != null) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Hãy chọn một ảnh.",
                userProfileImageLable: "Chọn ảnh...",
                userProfileImage: "",
            });
        }
    }
    ...
    handleUserTNC() {
        ...
        if (!userTNC) {
            ...
            this.setState({
                userTNC: false,
                showError: true,
                registerFormError: "Xác nhận sử dụng dịch vụ.",
            })
        }
    }
    ...
    async handleCreateAccountBtn() {
        ...
        if (!userName.match(userNameFormate)) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Sử dụng chữ thường, chữ hoa và dài hơn 10 kí tự.",
                userPassword: "",
            });
            ...
            this.setState({
                showError: true,
                registerFormError: "Hãy chọn một hình ảnh.",
                userProfileImageLable: "Chọn ảnh...",
                userProfileImage: "",
            });
        } else if (!userTNC) {
            this.setState({
                userTNC: false,
                showError: true,
                registerFormError: "Chấp nhận điều khoản.",
            })
        } else {
                ...
                <div className="container-fluid register-cont1">
                    <div className="">
                        ...
                        <div className="container register-cont1-text">
                            <h1 className="text-uppercase text-white text-center mb-4"><strong>Đăng nhập / Đăng ký</strong></h1>
                        </div>
                    </div>
                </div>
                    ...
                    {isRegisterForm ?
                            ...
                            <form action="javascript:void(0)">
                                ...
                                <div className="form-group">
                                    <div className="custom-control custom-checkbox">
                                        ...
                                        <label className="custom-control-label" htmlFor="userTNC">Chấp thuận điều khoản sử dụng dịch vụ</label>
                                    </div>
                                </div>
                                <p className="text-danger">{showError ? registerFormError : null}</p>
                                <button type="submit" className="btn btn-warning text-uppercase mb-3" onClick={this.handleCreateAccountBtn}><b>Đăng ký</b></button>
                            </form>
                            <p className="m-0">Đã có tài khoản? <span className="cursor-pointer text-warning" onClick={this.handleForms}>Đâng nhập</span></p>
                        </div> :
                        <div className="col-lg-4 col-md-6 col-sm-12 mx-auto bg-white shadow p-4">
                            ...
                            <form action="javascript:void(0)">
                                ...
                                <div className="form-group">
                                    <label htmlFor="userLoginPassword">Mật khẩu</label>
                                ...
                                <button type="submit" className="btn btn-warning text-uppercase mb-3" onClick={this.handleLoginNowBtn}><b>Đăng nhâoj</b></button>
                            </form>
                            <p className="m-0">Chưa có tài khoản? <span className="cursor-pointer text-warning" onClick={this.handleForms}>Đăng lý ngay</span></p>
                        </div>
                    }
                </div>
                <Footer />
