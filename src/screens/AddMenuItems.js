...
export default class AddMenuItems extends Component {
    ...
    async handleAddYourItemBtn() {
        ...
        if (!itemTitle) {
            ...
            this.setState({
                showError: true,
                registerFormError: "Mô tả không hợp lệ."
            })
        } else if (!itemPrice) {
            this.setState({
                showError: true,
                registerFormError: "Giá không hợp lệ."
            })
        }
        else if (!itemImage) {
            this.setState({
                showError: true,
                registerFormError: "Thêm hình ảnh."
            })
        }
        else if (!chooseItemType) {
            this.setState({
                showError: true,
                registerFormError: "Chọn danh mục."
            })
        } else {
            this.setState({
                showError: false,
                        ...
                        <form action="javascript:void(0)">
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    <label htmlFor="itemTitle"><b>Tên</b></label>
                                ...
                                <div className="form-group col-md-6">
                                    <label htmlFor="itemIngredients"><b>Mô tả</b></label>
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    <label htmlFor="itemPrice"><b>Giá</b></label>
                                ...
                                <div className="form-group col-md-6">
                                    <label className="mb-2"><b>Hình minh họa</b></label>
                            ...
                            <label className="mb-2"><b>Loại sản ph</b></label>
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="kebabs">Sinh tố</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="chicken">Trà sữa</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="bread">Soda</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="burgers">Gà</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="biryani">Cơm nhà</label>
                                    </div>
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="sauces">Nhật bản</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="vegetarian">Hàn quốc</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="specials">Khác</label>
                                    </div>
                                </div>
                            </div>
                            {showError ? <p className="text-danger">{registerFormError}</p> : null}
                            <button type="submit" className="btn btn-warning text-uppercase mb-3" onClick={this.handleAddYourItemBtn} ><b>Thêm</b></button>
                        </form>
                    </div>
                </div>
                <Footer />
