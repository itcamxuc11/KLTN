                        ...
                        <div className="container border-bottom pb-2 px-lg-0 px-md-0 mb-4" key={orderRequest[val].id}>
                                    ...
                                    return (
                                        <div className="row mb-3" key={val2}>
                                            ...
                                            <div className="col-lg-3 col-md-3 col-sm-12 px-0 text-right">
                                                <span style={{ fontSize: "14px" }} className="mx-3"><b>{orderRequest[val].itemsList[val2].itemPrice} đ</b></span>
                                            </div>
                                        </div>
                                    )
                                })
                            ...
                            <div className="row mb-3 mb-md-0 mb-lg-0">
                                ...
                                <div className="col-lg-6 col-md-6 col-12 text-lg-right text-md-right">
                                    <p><b className="mr-4">Tổng:</b><span style={{ fontSize: '1.1rem' }}>{orderRequest[val].totalPrice} đ</span></p>
                                </div>
                            </div>
                        </div>
                    )
                        ...
                        <div className="container border-bottom pb-2 px-lg-0 px-md-0 mb-4" key={orderRequest[val].id}>
                            ...
                            <div className="row mb-3 mb-md-0 mb-lg-0">
                                <div className="col-lg-6 col-md-6 col-12 order-lg-first order-md-first order-last ">
                                    ...
                                    <h6 style={{ fontSize: '15px' }} className="text-success">Đơn hàng đã giao thành công</h6>
                                </div>
                                <div className="col-lg-6 col-md-6 col-12 text-lg-right text-md-right">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className={tab1} onClick={() => this.handleTabs("tab1")}>
                                            <p className="order-req-tab-text"><FontAwesomeIcon icon="spinner" className="mr-3" />Chờ xác nhận</p>
                                        </div>
                                        <div className={tab2} onClick={() => this.handleTabs("tab2")}>
                                            <p className="order-req-tab-text"><FontAwesomeIcon icon="truck" className="mr-3" />Đang giao hàng</p>
                                        </div>
                                        <div className={tab3} onClick={() => this.handleTabs("tab3")}>
                                            <p className="order-req-tab-text"><FontAwesomeIcon icon="tasks" className="mr-3" />Giao thành công</p>
                                        </div>
                                    </div>
                                    {tab1Content &&
