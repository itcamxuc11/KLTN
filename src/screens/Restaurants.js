                    ...
                    <div className="container bg-white p-3 px-0 mb-4" key={restaurantList[val].id}>
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-12 py-4 px-0">
                                ...
                                <button type="button" onClick={() => this.handleViewMenuBtn(restaurantList[val])} className="btn btn-warning btn-sm text-uppercase" style={{ marginBottom: '8px' }}>Xem</button>
                            </div>
                        </div>
                    </div>
                )
                                        ...
                                        <ul className="filter-list">
                                            ...
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="chicken-roast">ABC</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="cheese-burger">ABC</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="cold-coffee">ABC</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
