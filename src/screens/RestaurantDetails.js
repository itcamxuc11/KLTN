                                        ...
                                        <div>
                                            <div className="row ">
                                                <div className="col-12">
                                                    <p style={{ backgroundColor: '#f1f3f8', padding: '10px 15px' }}>Total+ <span style={{ float: 'right', color: '#2f313a', fontSize: '14px', fontWeight: 700 }}><em>{totalPrice} đ</em></span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> : <p className="text-success">Chưa có sản phẩm nào trong giỏ hàng.</p>}
                                    <div>
                                        <div className="row ">
                                            <div className="col-12">
                                                <button onClick={() => this.handleConfirmOrderBtn()} type="button" className="btn btn-warning btn-sm btn-block text-uppercase mr-2 mr-1 px-3"><b>Đặt hàng</b></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
